...
const S: Record<string, React.CSSProperties> = {
  ...
  termHe: { fontSize: 15, fontWeight: 600 }, termEn: { fontSize: 12, letterSpacing: "1.5px", opacity: 0.6 },
  back: { color: "#8aa0c8", fontSize: 15, textDecoration: "none" },
  ...
  valueChip: { fontSize: 13, padding: "3px 10px", borderRadius: 20, background: "rgba(70,120,200,0.18)", color: "#bcd2f5" },
  statusChip: { fontSize: 13, padding: "3px 10px", borderRadius: 20, background: "rgba(52,211,153,0.14)", color: "#6ee7b7" },
  idName: { fontSize: 26, fontWeight: 800, margin: "0 0 6px", color: "#f4f8ff" },
  idMeta: { fontSize: 15, color: "#8aa0c8", marginBottom: 12 },
  strong: { color: "#e8edf6" },
  reason: { display: "grid", gap: 4, marginBottom: 10 },
  reasonText: { fontSize: 14, lineHeight: 1.6, color: "#cdd8ec" },
  goal: { fontSize: 14, color: "#cdd8ec" },
  goalLabel: { fontSize: 12, letterSpacing: "1px", color: "#5f7aa6", display: "block" },
  ...
  idStatL: { fontSize: 13, color: "#6a83ad", marginTop: 3 },
  ...
  joinNote: { fontSize: 13, color: "#6a83ad", lineHeight: 1.4 },
  joinError: { fontSize: 13, color: "#fca5a5", lineHeight: 1.4 },

  compose: { display: "flex", gap: 8, alignItems: "flex-start", marginBottom: 14 },
  composeBox: { flex: 1, resize: "vertical", padding: "9px 11px", borderRadius: 10, border: "1px solid rgba(110,160,240,0.22)", background: "rgba(12,20,36,0.6)", color: "#eaf1ff", fontSize: 13, lineHeight: 1.6, font: "inherit", fontFamily: "inherit" },
  composeBtn: { padding: "9px 14px", borderRadius: 10, border: "1px solid rgba(110,160,240,0.3)", background: "rgba(70,120,200,0.2)", color: "#eaf1ff", fontSize: 13, fontWeight: 600, cursor: "pointer", font: "inherit", whiteSpace: "nowrap" },
  composeBtnOff: { opacity: 0.45, cursor: "default" },
  composeNote: { fontSize: 13, color: "#6a83ad", marginBottom: 12 },
  ...
  cardHint: { fontSize: 12, color: "#5f7aa6" },
  prov: { fontSize: 12, color: "#5f7aa6" },
  empty: { fontSize: 15, color: "#7f93b5", lineHeight: 1.6 },
  sub: { fontSize: 13, color: "#8aa0c8", margin: "16px 0 8px", fontWeight: 600 },

  feed: { display: "grid", gap: 8 },
  feedRow: { display: "flex", alignItems: "center", gap: 10 },
  feedTime: { fontSize: 13, color: "#6a83ad", width: 42, fontVariantNumeric: "tabular-nums" },
  feedDot: { width: 7, height: 7, borderRadius: "50%", flexShrink: 0 },
  feedText: { fontSize: 13.5, color: "#cdd8ec", flex: 1 },
  feedActor: { fontSize: 13, color: "#5f7aa6" },
  ...
  leaderRole: { fontSize: 13, color: "#8aa0c8" },
  leaderMeta: { fontSize: 13, color: "#5f7aa6", marginTop: 2 },

  people: { display: "flex", flexWrap: "wrap", gap: 8 },
  person: { fontSize: 13, padding: "5px 12px", borderRadius: 20, background: "rgba(90,120,180,0.12)", color: "#cdd8ec" },
  ...
  budgetL: { fontSize: 13, color: "#6a83ad", marginTop: 2 },
  ...
  txnWho: { fontSize: 15, color: "#cdd8ec" },
  txnReason: { fontSize: 13, color: "#8aa0c8" },
  txnStatus: { fontSize: 13, color: "#5f7aa6" },
  ...
  allocValue: { fontSize: 13, color: "#7f93b5", fontWeight: 400 },
  allocMeta: { fontSize: 13, color: "#7f93b5", marginTop: 3 },
  allocRight: { textAlign: "left" },
  allocAmt: { fontSize: 14, fontWeight: 700, color: "#e8edf6" },
  allocStatus: { fontSize: 13, color: "#8aa0c8", marginTop: 3 },
  stOk: { color: "#34d399" },
  stNear: { color: "#facc15" },
  ...
  impactStat: { fontSize: 13, color: "#8aa0c8" },
  impactN: { fontSize: 18, color: "#f4f8ff" },
  verify: { fontSize: 13, padding: "7px 12px", borderRadius: 10, display: "inline-block", justifySelf: "start" },
  ...
  evidence: { fontSize: 13, color: "#5f7aa6" },
  review: { fontSize: 13, color: "#a78bfa", lineHeight: 1.5 },
  reviewReason: { fontSize: 13, color: "#8aa0c8", marginTop: 2 },

  valueLead: { fontSize: 22, fontWeight: 800, color: "#f4f8ff", marginBottom: 10 },
  secondary: { display: "inline-block", marginTop: 12, fontSize: 13, color: "#8aa0c8", textDecoration: "none" },
};
