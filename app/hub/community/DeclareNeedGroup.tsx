...
const S: Record<string, React.CSSProperties> = {
  ...
  needText: { fontSize: 11.5, color: "#dbe6f6", lineHeight: 1.5 },
  code: { fontSize: 8.5, fontFamily: "ui-monospace, monospace", color: "#7f97c2" },
  state: { fontSize: 9.5, color: "#8798b8", fontStyle: "italic", margin: "3px 0 6px" },
  form: { display: "flex", flexDirection: "column", gap: 6 },
  input: { background: "#0d1424", border: "1px solid #2a3f66", borderRadius: 7, padding: "6px 9px", fontSize: 11, color: "#e8eefb" },
  row: { display: "flex", alignItems: "center", gap: 7 },
  btn: { background: "#34d399", color: "#02101f", border: "none", borderRadius: 7, padding: "5px 12px", fontSize: 11, fontWeight: 700, cursor: "pointer" },
  btnGhost: { background: "transparent", color: "#9fb0d0", border: "1px solid #2a3f66", borderRadius: 7, padding: "5px 11px", fontSize: 10.5, cursor: "pointer" },
  fine: { fontSize: 8.5, color: "#5a6f96", lineHeight: 1.5 },
  done: { fontSize: 10.5, color: "#34d399", border: "1px solid rgba(52,211,153,0.35)", borderRadius: 8, padding: "7px 10px", marginBottom: 8, background: "rgba(52,211,153,0.06)" },
  err: { fontSize: 10.5, color: "#f2635c", marginTop: 5 },
};
