...
const S: Record<string, React.CSSProperties> = {
  ...
  code: { fontSize: 10, fontFamily: "ui-monospace, monospace", color: "#7f97c2" },
  state: { fontSize: 10, color: "#8798b8", fontStyle: "italic", margin: "3px 0 6px" },
  ...
  fine: { fontSize: 10, color: "#5a6f96", lineHeight: 1.5 },
