...
const S: Record<string, React.CSSProperties> = {
  ...
  rule: { fontSize: 11, color: COLOR.textDim, lineHeight: 1.55, background: "rgba(251,191,36,0.05)", border: "1px solid rgba(251,191,36,0.22)", borderRadius: RADIUS.sm, padding: "6px 9px" },
  ...
  none: { fontSize: 10.5, color: "#8798b8", fontStyle: "italic", padding: "2px 0" },
  ...
  qText: { fontSize: 12, color: COLOR.text, flex: 1, minWidth: 200 },
  qMeta: { fontSize: 8.5, color: COLOR.textFaint, fontFamily: "ui-monospace, monospace" },
  footer: { marginTop: SPACE.sm, paddingTop: 6, borderTop: `1px solid ${COLOR.border}`, fontSize: 10.5, color: COLOR.textFaint, lineHeight: 1.5 },
};
