...
export default function CreateOfferForm() {
  ...
  return (
    ...
    >
      <div style={{ fontSize: 13, letterSpacing: 0.5, color: "#8fa3c9" }}>משאב חדש · NEW OFFER (person_roei) — אותו Offer store כמו /marketplace</div>
...
const inputStyle: React.CSSProperties = { background: "#0b0f1a", color: "#e8edf6", border: "1px solid #2a3550", borderRadius: 6, padding: "6px 8px", fontSize: 13, flex: 1, minWidth: 120 };
