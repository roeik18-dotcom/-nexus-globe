...
const S: Record<string, React.CSSProperties> = {
  ...
  head: { fontSize: 12, fontWeight: 700, color: "#5aa6ff" },
  count: { fontSize: 10, color: "#5a76a3" },
  controls: { display: "flex", gap: 10, alignItems: "center", margin: "8px 0" },
  search: { flex: 1, maxWidth: 340, background: "rgba(18,24,38,0.7)", border: "1px solid rgba(90,120,180,0.3)", borderRadius: 8, padding: "6px 10px", color: "#e6ebf5", fontSize: 11.5 },
  toggle: { display: "flex", alignItems: "center", gap: 5, fontSize: 10.5, color: "#8fa3c9" },
  ...
  empty: { padding: 14, fontSize: 11, color: "#5a76a3", textAlign: "center" },
  ...
  rowSection: { fontSize: 10, color: "#5a76a3", whiteSpace: "nowrap" },
  rowArrow: { fontSize: 10, color: "#5a76a3" },
  rowHeading: { fontSize: 11.5, color: "#dbe6f6", fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  rowMeta: { display: "flex", gap: 10, fontSize: 9.5, color: "#8aa0c8", whiteSpace: "nowrap" },
