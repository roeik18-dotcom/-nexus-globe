...
const S: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: 15, fontWeight: 800, margin: 0, color: COLOR.text, direction: "ltr", textAlign: "right" },
  ...
  row: { display: "flex", justifyContent: "space-between", gap: 8, padding: "4px 8px", borderRadius: RADIUS.sm, background: "rgba(90,120,180,0.05)", fontSize: 13, marginBottom: 3, lineHeight: 1.45 },
  meta: { color: "#8aa0c8", fontSize: 12 },
