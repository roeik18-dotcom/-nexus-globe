...
Values:     { Physical: 0.10, Emotional: 0.30, Rational: 0.60 }`,
  ...
  failureType: {
    ...
    relatedConcepts: ['capacity_shortage', 'flow_disconnection', 'mobilization_gap', 'resolved', 'Action'],
    status: 'stable',
    userFacing: true,
  },
  ...
  Action: {
    ...
    relatedConcepts: ['firstMove', 'targetDimension', 'targetDepartment', 'ActionId'],
    status: 'stable',
    userFacing: true,
  },
